...
CREATE TABLE COURSE_ENROLLMENT (
    ID INT DEFAULT COURSE_ENROLLMENT_SEQUENCE.NEXTVAL PRIMARY KEY,
    COURSE_ID INT NOT NULL,
    USER_ID VARCHAR(40) NOT NULL,
    PINNED BOOLEAN DEFAULT FALSE,
    CONSTRAINT U_COURSE_ID_USER_ID UNIQUE (COURSE_ID, USER_ID),
    CONSTRAINT FK_COURSE_ENROLLMENT_COURSE_ID_COURSE_ID FOREIGN KEY (COURSE_ID) REFERENCES COURSE(ID) ON DELETE CASCADE
);
